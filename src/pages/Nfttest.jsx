...
const Nfttest = () => {
  ...
  const refundticket = async(e) => {
    ...
    return (<div className="tab2-container shadow-md text-white">
      <div className="flex flex-col">
      <form onSubmit={buyticket}>
        <input className='text-black' type="text" value={buyId} onChange={(e)=>setBuyId(e.target.value)}></input>
        <input type="submit" value="민팅"/>
      </form>
      <form onSubmit={useticket}>
        <input className='text-black' type="text" value={useId} onChange={(e)=>setUseId(e.target.value)}></input>
        <input type="submit" value="사용"/>
      </form>
      <form onSubmit={refundticket}>
        <input className='text-black' type="text" value={reId} onChange={(e)=>setReId(e.target.value)}></input>
